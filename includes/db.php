...
function cms_init_db(PDO $db): void
{
    if (cms_db_driver() === 'mysql') {
        ...
        $db->exec("CREATE TABLE IF NOT EXISTS cms_users (
            ...
            admin_theme VARCHAR(30) NOT NULL DEFAULT 'dark',
        ...
        foreach ([
            ...
            "ALTER TABLE cms_pages ADD COLUMN meta_title VARCHAR(191) NOT NULL DEFAULT '' AFTER content",
            "ALTER TABLE cms_pages ADD COLUMN meta_description TEXT NOT NULL AFTER meta_title",
            "ALTER TABLE cms_users ADD COLUMN twofa_enabled TINYINT(1) NOT NULL DEFAULT 0",
            "ALTER TABLE cms_users ADD COLUMN admin_theme VARCHAR(30) NOT NULL DEFAULT 'dark'",
        ...
        $db->exec("CREATE TABLE IF NOT EXISTS cms_users (
            ...
            admin_theme TEXT NOT NULL DEFAULT 'dark',
        ...
        foreach ([
            ...
            "ALTER TABLE cms_users ADD COLUMN admin_theme TEXT NOT NULL DEFAULT 'dark'",
