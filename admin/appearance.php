...
<div class="layout">
    ...
    <main class="main">
        <div class="topbar"><div><h1 style="margin:0 0 6px"><?= htmlspecialchars(cms_t('admin.appearance.heading', 'Wyglad witryny')) ?></h1><div class="muted"><?= htmlspecialchars(cms_t('admin.appearance.subheading', 'Wizualny edytor calego stylu strony.')) ?></div></div></div>
